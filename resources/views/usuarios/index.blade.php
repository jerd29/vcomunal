...
@section('content')
    ...
    <div class="card-body">
        <ul class="list-group mb-4" style="list-style-type:none;">
            <li><button class="btn btn-primary btn-sm"><i class="fas fa-plus"> Añadir un nuevo Usuario</i></button></li>
        </ul>
        <table class="table table-striped" id="reporte_org">
            <thead>
